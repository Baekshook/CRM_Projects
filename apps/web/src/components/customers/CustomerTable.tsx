...
const CustomerTable: React.FC<CustomerTableProps> = ({
  ...
  const getProfileImageUrl = (entity: any) => {
    return entity.profileImage && entity.profileImage.length > 0
      ? entity.profileImage.startsWith("http")
        ? entity.profileImage
            ...
            <tr key={entity.id} className="hover:bg-gray-50 transition-colors">
              <td className="px-6 py-4 whitespace-nowrap">
                <input
                  ...
                  onChange={(e) =>
                    handleSelectEntity(entity.id, e.target.checked)
                  }
                />
              </td>
              <td className="px-6 py-4 whitespace-nowrap">
              ...
              <td className="px-6 py-4 whitespace-nowrap">
                ...
                {isSinger(entity) && (
                  <div className="text-sm text-gray-500">{entity.genre}</div>
                )}
              </td>
              <td className="px-6 py-4 whitespace-nowrap">
